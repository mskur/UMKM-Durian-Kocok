...
<header class="tengah bg-primary text-white py-5">
    <div class="container text-center">
        ...
        <p class="lead fw-normal text-white-50 mb-4"><small>Quickly design and customize responsive mobile-first</br> sites with Bootstrap, the world’s most popular front-end open source toolkit!</small></p>
    </div>
</header>
