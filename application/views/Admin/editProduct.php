                        ...
                        <div class="card-body">
                          <form action="<?= base_url('productDURCOK/editProductDurianKocokAction'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="namaProduct" id="namaProduct" class="form-control" placeholder="Nama Produk" value="<?= $product->namaProduct; ?>" required>
                                        <?= form_error('namaProduct'); ?>
                                    </div>

                                    <div class="mb-3">
                                        <label for="hargaProduct" class="form-label">Harga Produk</label>
                                        <input type="number" name="hargaProduct" id="hargaProduct" class="form-control" placeholder="Harga Produk" value="<?= $product->hargaProduct; ?>" required min="0" max="9000000">
                                        <?= form_error('hargaProduct'); ?>
                                    </div>

                                    <div class="mb-3">
                                        <?php if($product->gambarProduct == NULL) : ?>
                                            <img src="<?= base_url('assets/img/product/default.jpg'); ?>" alt="default.jpg" class="img-thumbnail" width="200px">
                                        <?php else : ?>
                                            <img src="<?= base_url('assets/img/product/') . $product->gambarProduct; ?>" alt="<?= $product->namaProduct; ?>" class="img-thumbnail" width="200px">
                                        <?php endif; ?>
                                        <input type="hidden" name="gambarProductLama" value="<?= $product->gambarProduct; ?>">
                                        <input type="file" name="gambarProduct" id="gambarProduct" class="form-control">
                                    ...
                                    <div class="mb-3">
                                        <label for="diskonProduct" class="form-label" id="diskonProductLabel">Diskon Produk (Opsional)</label>
                                        <input type="number" name="diskonProduct" id="diskonProduct" class="form-control" placeholder="Diskon Produk" value="<?= $product->diskonProduct; ?>" min="0" max="100" aria-labelledby="diskonProductLabel">
                                        <?= form_error('diskonProduct'); ?>
                                    </div>

                                    <div class="mb-3">
                                        <label for="deskripsiProduct" class="form-label" id="deskripsiProductLabel">Deskripsi Produk</label>
                                        <textarea name="deskripsiProduct" id="deskripsiProduct" class="form-control" placeholder="Deskripsi Produk" required aria-labelledby="deskripsiProductLabel"><?= $product->deskripsiProduct; ?></textarea>
