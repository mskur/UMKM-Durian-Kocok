                        ...
                        <div class="card-body">
                          <form action="<?= base_url('productDURCOK/addProductDurianKocokAction'); ?>" method="post" enctype="multipart/form-data">
                              <div class="mb-3">
                                  ...
                                  <input type="text" name="namaProduct" id="namaProduct" class="form-control" placeholder="Nama Produk" value="<?= set_value('namaProduct'); ?>" required>
                                  <?= form_error('namaProduct'); ?>
                              </div>

                              <div class="mb-3">
                                  <label for="hargaProduct" class="form-label">Harga Produk</label>
                                  <input type="number" name="hargaProduct" id="hargaProduct" class="form-control" placeholder="Harga Produk" value="<?= set_value('hargaProduct'); ?>" required min="0" max="9000000">
                                  <?= form_error('hargaProduct'); ?>
                              </div>

                              <div class="mb-3">
                                  <label for="gambarProduct" class="form-label">Gambar Produk</label>
                                  <input type="file" name="gambarProduct" id="gambarProduct" class="form-control" placeholder="Gambar Produk" value="<?= set_value('gambarProduct'); ?>">
                              ...
                              <div class="mb-3">
                                  <label for="diskonProduct" class="form-label">Diskon Produk (Opsional)</label>
                                  <input type="number" name="diskonProduct" id="diskonProduct" class="form-control" placeholder="Diskon Produk" value="<?= set_value('diskonProduct'); ?>" min="0" max="100">
                                  <?= form_error('diskonProduct'); ?>
                              </div>

                              <div class="mb-3">
                                  <label for="deskripsiProduct" class="form-label">Deskripsi Produk</label>
                                  <textarea name="deskripsiProduct" id="deskripsiProduct" class="form-control" placeholder="Deskripsi Produk" required><?= set_value('deskripsiProduct'); ?></textarea>
