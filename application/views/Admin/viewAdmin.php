            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                                <?php if ($level == 'superadmin') : ?>
                                    <a class="nav-link dropdown-toggle" id="userDropdown" role="button"
                                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="<?= base_url('Admin'); ?>">
                                        <i class="fas fa-user me-3"></i> Admin
                                    </a>
                                <?php elseif ($level == 'admin') : ?>
                                    <a class="nav-link dropdown-toggle" id="userDropdown" role="button"
                                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="<?= base_url('Admin'); ?>">
                                        <i class="fas fa-user me-3"></i> User Admin
                                    </a>
                                <?php endif; ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <a href="<?= base_url('addAdmin'); ?>" class="btn btn-primary mb-3">Add Admin</a>

                            <!-- Display flash message -->
                            <p class="alert alert-info"><?= $this->session->flashdata('pesan'); ?></p>
                                    ...
                                    <tbody>
                                        <?php foreach($allAdmin as $admin) : ?>
                                            <tr>
                                                ...
                                                <?php else :?>
                                                    <td>
                                                        <a href="<?= base_url('updateAdmin/'.$admin->username); ?>" class="btn btn-warning btn-sm">Update</a>
                                                        <a href="<?= base_url('deleteAdmin/'.$admin->username); ?>" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endforeach; ?>
