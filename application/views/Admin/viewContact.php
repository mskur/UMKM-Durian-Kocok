                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="contactDURCOK/editContactAction" method="post">
                                <div class="mb-3">
                                    <label for="alamatWebsite" class="form-label">Alamat Website</label>
                                    <input type="text" name="alamatWebsite" id="alamatWebsite" class="form-control" placeholder="Alamat Website" value="<?= $contact->alamatWebsite; ?>" required>
                                    <?= form_error('alamatWebsite'); ?>
                                </div>

                                <div class="mb-3">
                                    <label for="nomorTelepon" class="form-label">Nomor Telepon</label>
                                    <input type="text" name="nomorTelepon" id="nomorTelepon" class="form-control" placeholder="Nomor Telepon" pattern="[0-9]*" maxlength="15" value="<?= $contact->nomorTelepon; ?>" required>
                                    <?= form_error('nomorTelepon'); ?>
                                </div>

                                <div class="mb-3">
                                    <label for="alamatLengkap" class="form-label">Alamat Lengkap</label>
                                    <textarea name="alamatLengkap" id="alamatLengkap" class="form-control" rows="4" placeholder="Alamat Lengkap" required><?= $contact->alamatLengkap; ?></textarea>
                                    <?= form_error('alamatLengkap'); ?>
                                </div>

                                <div class="mb-3">
                                    <label for="alamatLive" class="form-label">Alamat Live</label>
                                    <input type="text" name="alamatLive" id="alamatLive" class="form-control" placeholder="Alamat Live" value="<?= $contact->alamatLive; ?>" required>
