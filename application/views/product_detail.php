...
<!-- Navbar -->
<!-- Start Hero Area -->
    <section class="hero-area" style="margin-top: 6%; margin-bottom: 2%;">
        <div class="container">
            <div class="row">
    ...
    <section class="py-5 item-details section">
        <section class="py-1">
              <div class="container px-5">
                  <center><h1 class="fw-bolder fs-5 mb-2">D E T A I L  P R O D U C T</h1><h1 class="fw-bolder fs-1 mb-5" style="margin-top: -1%;">DURIAN KOCOK</h1></center>
              </div>
            </section>
        <div class="container">
            <div class="top-area">
